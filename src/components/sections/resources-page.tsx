...
//
// export function ResourcesPage() {
//   const [openFaq, setOpenFaq] = React.useState<string | null>(
//     resourceFaqs[0]?.[0] ?? null
//   )
//
//   return (
//     <>
...
//                       className="flex w-full cursor-pointer items-center justify-between gap-5 text-left text-sm font-semibold"
//                     >
//                       <span>{question}</span>
//                       <span
